...
:::note
Jeśli używasz starszej wersji Lefthook i widzisz surowe sekwencje ucieczki ANSI w terminalu, powinieneś albo zaktualizować Lefthook, albo skonfigurować kolory Lefthook / ustawić `NO_COLOR`. Alternatywnie, możesz przekazać opcję `--colors=off` do Biome.
:::
